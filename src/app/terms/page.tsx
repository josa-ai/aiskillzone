...
export const metadata = {
  ...
  description:
    "Terms and Conditions for using JOSA.AI / Josato Group LLC — your agreement for using our website and services.",
};

export default function TermsPage() {
  return (
    <div className="bg-brand-midnight-plum text-brand-soft-lavender">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-sm text-brand-soft-lavender/50">
          Effective as of February 01, 2025
        </p>

        <div className="mt-10 space-y-8 text-sm leading-7 text-brand-soft-lavender/80 sm:text-base [&_h2]:mt-10 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-white [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1">

          <section>
            <h2>Agreement between User and https://josa.ai</h2>
            <p>
              Welcome to https://josa.ai. The https://josa.ai website (the
              &ldquo;Site&rdquo;) is comprised of various web pages operated by Josato
              Group LLC D/B/A Josa.ai (&ldquo;Josa.ai&rdquo;). https://josa.ai is
              ...
              &ldquo;Terms&rdquo;). Your use of https://josa.ai constitutes your
              agreement to all such Terms. Please read these terms carefully, and keep
              a copy of them for your reference.
            </p>
            <p className="mt-4">
              https://josa.ai is an E-Commerce Site selling SaaS services.
            </p>
          </section>
          ...
          <section>
            <h2>Privacy</h2>
            <p>
              Your use of https://josa.ai is subject to Josa.ai&apos;s{" "}
              <a
                href="/privacy"
                className="text-brand-tech-blue hover:text-brand-mauve-purple transition-colors"
              >
                Privacy Policy
              </a>
          ...
          <section>
            ...
            <p>
              Visiting https://josa.ai, sending SMS messages or sending emails to
              Josa.ai constitutes electronic communications. You consent to receive
              electronic communications and you agree that all agreements, notices,
              disclosures and other communications that we provide to you
              electronically, via email, via SMS messaging and on the Site, satisfy
          ...
          <section>
            ...
            <p>
              ...
              acknowledge that Josa.ai is not responsible for third party access to
              your account that results from theft or misappropriation of your
              account. Josa.ai and its associates reserve the right to refuse or
          ...
          <section>
            ...
            <p>
              Josa.ai does not knowingly collect, either online or offline, personal
              information from persons under the age of thirteen. If you are under 18,
              you may use https://josa.ai only with permission of a parent or
              guardian.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              after 14 days of the trial period will not qualify for a refund. Please
              contact us at{" "}
              <a
          ...
          <section>
            ...
            <p>
              https://josa.ai may contain links to other websites
              (&ldquo;Linked Sites&rdquo;). The Linked Sites are not under the control
              of Josa.ai and Josa.ai is not responsible for the contents of any Linked
              Site, including without limitation any link contained in a Linked Site,
              or any changes or updates to a Linked Site. Josa.ai is providing these
              links to you only as a convenience, and the inclusion of any link does
              not imply endorsement by Josa.ai of the site or any association with its
              operators.
            </p>
            <p className="mt-4">
              Certain services made available via https://josa.ai are delivered by
              third party sites and organizations. By using any product, service or
              functionality originating from the https://josa.ai domain, you hereby
              acknowledge and consent that Josa.ai may share such information and data
              with any third party with whom Josa.ai has a contractual relationship to
              provide the requested product, service or functionality on behalf of
              https://josa.ai users and customers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              access and use https://josa.ai strictly in accordance with these terms
              of use. As a condition of your use of the Site, you warrant to Josa.ai
            ...
            <p className="mt-4">
              ...
              on the Site, is the property of Josa.ai or its suppliers and protected
            ...
            <p className="mt-4">
              ...
              of the content, in whole or in part, found on the Site. Josa.ai content
              ...
              permission of Josa.ai and the copyright owner. You agree that you do not
              ...
              Josa.ai or our licensors except as expressly authorized by these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Josa.ai has no obligation to monitor the Communication Services.
              However, Josa.ai reserves the right to review materials posted to a
              Communication Service and to remove any materials in its sole
              discretion. Josa.ai reserves the right to terminate your access to any
            ...
            <p className="mt-4">
              ...
              about yourself or your children in any Communication Service. Josa.ai
              does not control or endorse the content, messages or information found
              in any Communication Service and, therefore, Josa.ai specifically
          ...
          <section>
            <h2>Materials Provided to https://josa.ai or Posted on Any Josa.ai Web Page</h2>
            <p>
              Josa.ai does not claim ownership of the materials you provide to
              https://josa.ai (including feedback and suggestions) or post, upload,
              input or submit to any Josa.ai Site or our associated services
              (collectively &ldquo;Submissions&rdquo;). However, by posting,
              uploading, inputting, providing or submitting your Submission you are
              granting Josa.ai, our affiliated companies and necessary sublicensees
            ...
            <p className="mt-4">
              ...
              as provided herein. Josa.ai is under no obligation to post or use any
              Submission you may provide and may remove any Submission at any time in
              Josa.ai&apos;s sole discretion.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You will be able to connect your Josa.ai account to third party
              accounts. By connecting your Josa.ai account to your third party
          ...
          <section>
            ...
            <p>
              The Service is controlled, operated and administered by Josa.ai from
              ...
              You agree that you will not use the Josa.ai Content accessed through
              https://josa.ai in any country or in any manner prohibited by any
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend and hold harmless Josa.ai, its officers,
              ...
              or services, any user postings made by you, your violation of any terms
              of this Agreement or your violation of any rights of a third party, or
              your violation of any applicable laws, rules or regulations. Josa.ai
              ...
              which event you will fully cooperate with Josa.ai in asserting any
              available defenses.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              and judgment may be entered upon it in any court having jurisdiction. In
              ...
              claims in regards to these Terms and Conditions or any disputes arising
              as a result of these Terms and Conditions, whether directly or
              ...
              the interpretation and enforcement of this provision. The entire dispute,
              including the scope and enforceability of this arbitration provision
              shall be determined by the Arbitrator. This arbitration provision shall
          ...
          <section>
            ...
            <p>
              ...
              CLAIMS AGAINST THE OTHER ONLY IN EACH&apos;S INDIVIDUAL CAPACITY, AND
              NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PUTATIVE CLASS, COLLECTIVE
              AND/OR REPRESENTATIVE PROCEEDING, SUCH AS IN THE FORM OF A PRIVATE
              ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless both you and
              Josa.ai agree otherwise, the arbitrator may not consolidate more than
          ...
          <section>
            ...
            <p className="uppercase text-xs leading-6 text-brand-soft-lavender/70">
              ...
              JOSATO GROUP LLC D/B/A JOSA.AI AND/OR ITS SUPPLIERS MAY MAKE
              IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.
            </p>
            <p className="mt-4 uppercase text-xs leading-6 text-brand-soft-lavender/70">
              JOSATO GROUP LLC D/B/A JOSA.AI AND/OR ITS SUPPLIERS MAKE NO
              ...
              SOFTWARE, PRODUCTS, SERVICES AND RELATED GRAPHICS ARE PROVIDED &ldquo;AS
              IS&rdquo; WITHOUT WARRANTY OR CONDITION OF ANY KIND. JOSATO GROUP LLC
              D/B/A JOSA.AI AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES AND
            ...
            <p className="mt-4 uppercase text-xs leading-6 text-brand-soft-lavender/70">
              ...
              JOSATO GROUP LLC D/B/A JOSA.AI AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
              ...
              LIABILITY OR OTHERWISE, EVEN IF JOSATO GROUP LLC D/B/A JOSA.AI OR ANY
          ...
          <section>
            ...
            <p>
              Josa.ai reserves the right, in its sole discretion, to terminate your
              ...
              agreement is governed by the laws of the State of Florida and you hereby
              consent to the exclusive jurisdiction and venue of courts in Florida in
            ...
            <p className="mt-4">
              ...
              relationship exists between you and Josa.ai as a result of this
              agreement or use of the Site. If any part of this agreement is
            ...
            <p className="mt-4">
              ...
              agreement between the user and Josa.ai with respect to the Site and it
              supersedes all prior or contemporaneous communications and proposals,
              whether electronic, oral or written, between the user and Josa.ai with
              respect to the Site. It is the express wish to the parties that this
          ...
          <section>
            ...
            <p>
              Josa.ai reserves the right, in its sole discretion, to change the Terms
              under which https://josa.ai is offered. The most current version of the
              Terms will supersede all previous versions. Josa.ai encourages you to
          ...
          <section>
            <h2>Contact Us</h2>
            <p>
              Josa.ai welcomes your questions or comments regarding the Terms:
            </p>
            <address className="mt-4 not-italic space-y-1 text-brand-soft-lavender/80">
              <p>Josato Group LLC D/B/A Josa.ai</p>
              <p>2818 Kinsley St</p>
              <p>Lakeland, Florida 33812</p>
              <p className="mt-2">
                Email:{" "}
                <a
                  href="mailto:info@josa.ai"
